...
class MainApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        body: Center(
          child: GestureDetector(onTap: () {}, child: Text('Hello World!')),
        ),
      ),
    );
  }
...
class _MainScreenState extends State<_MainScreen> {
  ...
  final String DynamicLink = 'https://google.com';
  ...
  Future<void> _createDynamicLink(bool short) async {
    ...
    final DynamicLinkParameters parameters = DynamicLinkParameters(
      uriPrefix: 'https://hiyu.page.link',
      longDynamicLink: Uri.parse(
        'https://hiyu.page.link?user',
      ),
      link: Uri.parse(DynamicLink),
      androidParameters: const AndroidParameters(
        packageName: 'com.example.test_dynamic_link',
        minimumVersion: 0,
      ),
                ...
                children: <Widget>[
                  ButtonBar(
                    ...
                    children: <Widget>[
                      ...
                      ElevatedButton(
                        onPressed: !_isCreatingLink ? () => _createDynamicLink(false) : null,
                        child: const Text('Get Long Link'),
                      ),
                      ElevatedButton(
                        onPressed: !_isCreatingLink ? () => _createDynamicLink(true) : null,
